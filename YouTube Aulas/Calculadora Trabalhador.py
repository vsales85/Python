...
if opcao==5:
    ...
    if  salario >= 1903.99 and salario<= 2826.65:
        print('Você vai pagar 7,5%: {:.2f}'.format(salario*7.5/100))

    if salario >= 2826.66 and salario <= 3751.05:
        print('Você vai pagar 15%: {:.2f}'.format(salario*15/100))

    if  salario >= 3751.06  and salario  <=  4664.68:
        print('Você vai pagar 22.5%: {:.2f}'.format(salario*22.5/100))
    if salario  >=  4664.69:
        print('Você vai pagar 27.5%: {:.2f}'.format(salario*27.5/100))
else:
    print('Sair')